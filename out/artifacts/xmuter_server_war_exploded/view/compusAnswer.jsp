<%@ page import="edu.xmuter.bean.User" %><%--
        ...
        <div id="middle">
            ...
            <div class="con">
                            ...
                            <tr>
                                <td>
                                    <div class="single_list" style="width: 100%;display: block;">
                                        ...
                                        <div class="detail">
                                            <h2>
                                                <a href="${root_path}Servlet_get_problem_detail?pno=${problem.pno}">${problem.p_content}</a>
                                            </h2>
                                            <p>
                                                <!-- 答疑数 -->
                                                ...
                                                <a href="#" aria-hidden="true"
                                                   onclick="get_answer(${problem.pno} ,this)">${problem.ans_num}</a>条回答
                                                &nbsp;&nbsp;&nbsp;<span> ${problem.p_date}</span>
                                            </p>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="cbox cbox1">
                    ...
                    <table>
                        <c:forEach items="${sessionScope.problems}" var="problem">
                            <c:if test="${problem.author_no eq sessionScope.user.uno}">
                                <tr>
                                    <td>
                                        <div class="single_list" style="width: 100%;display: block;">
                                            <div class="thumb">
                                    ...
                                    <td>
                                        <button  style="width:100px; height: 50px; margin-left: 200px;" onclick="delete_problem(${problem.pno},this)" >delete</button>
                                    </td>
                                </tr>
                            </c:if>
                        </c:forEach>
...
<script>
    ...
    function delete_problem(pno, obj) {


        $.ajax({
            type: "post",
            url: " ${root_path}Servlet_delete_problem",
            data: {'pno': pno,},
            datatype: 'json',
            success: function (data) {
                if (data != null) {
